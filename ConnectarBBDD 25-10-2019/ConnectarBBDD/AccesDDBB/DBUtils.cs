...
namespace AccesDDBB
{
    public class DBUtils
    {
        ...
        public bool InsertarUsuariSQL(string name)
        {
            ...
            string insert = "INSERT INTO Users(CodeUser, UserName, Login, Password, idUserRank, idUserCategory, Photo, idPlanet, idSpecie, Salt)" + "VALUES ('PRUEBA', '" + name + "', '2', 'AA6chstdhiLHs3/u6b2uTjP0lmW/StFA', 1, 1, 'Adri.jpg', 1, 1, 'KbljdrQ0PpRdG59FHp7nTPou9ATlrymK');";
            try
            {
                ObrirConnexioSQL();
